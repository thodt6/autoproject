...
import com.unibro.objtemplate.utils.ElasticApiUtils;
import com.unibro.objtemplate.utils.MySQLApiUtils;
import com.unibro.objtemplate.utils.OracleApiUtils;
...
//            logger.info(xhtml_content);
    ...
    private void generateMySqlApiCode() {
        MySQLApiUtils util = new MySQLApiUtils(this);
        util.generateCode();
    }

    //Oracle API  
    private void generateOracleApiCode() {
        OracleApiUtils util=new OracleApiUtils(this);
        util.generateCode();
...
//        this.writeOracleApiObjClassDataSource();
    ...
    private void generateElasticApiCode() {
        ElasticApiUtils util = new ElasticApiUtils(this);
        util.generateCode();
    }
